  ...
  try {
    ...
    return NextResponse.json({
      ...
      growthPeriodStats: {
        ...
        restSeasons: growthStats?.rest_seasons ?? restSeasonsCount,                 // DB 우선, 없으면 실시간 계산
        approvedSeasons: growthStats?.approved_seasons ?? approvedSeasonsCount,       // DB 우선, 없으면 실시간 계산
      },
