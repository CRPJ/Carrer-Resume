...
const Cluster41Content = () => {
  ...
  // 성장 상태 타입
  const growthStatusOptions = ["성공", "실패", "휴식(개인)", "휴식(공식)"] as const;

  // 주차별 데이터 (이미지와 타이틀 매핑)
  const weeklyData = [
    {
      id: 1,
      image: "/images/0/cluster 4/주차 이미지/여름 8주차 (8월 4주차).png",
    ...
    {
      id: 2,
      image: "/images/0/cluster 4/주차 이미지/여름 7주차 (8월 3주차).png",
    ...
    {
      id: 3,
      image: "/images/0/cluster 4/주차 이미지/여름 6주차 (8월 2주차).png",
    ...
    {
      id: 4,
      image: "/images/0/cluster 4/주차 이미지/여름 5주차 (8월 1주차).png",
    ...
    {
      id: 5,
      image: "/images/0/cluster 4/주차 이미지/여름 4주차 (7월 4주차).png",
      ...
      rating: 5,
      growthStatus: growthStatusOptions[Math.floor(Math.random() * 4)],
    },
    {
      id: 6,
      image: "/images/0/cluster 4/주차 이미지/여름 3주차 (7월 3주차).png",
    ...
    {
      id: 7,
      image: "/images/0/cluster 4/주차 이미지/여름 2주차 (7월 2주차).png",
    ...
    {
      id: 8,
      image: "/images/0/cluster 4/주차 이미지/여름 1주차 (7월 1주차).png",
    ...
    {
      id: 9,
      image: "/images/0/cluster 4/주차 이미지/봄 16주차 (6월 4주차).png",
    ...
    {
      id: 10,
      image: "/images/0/cluster 4/주차 이미지/봄 15주차 (6월 3주차).png",
    ...
    {
      id: 11,
      image: "/images/0/cluster 4/주차 이미지/봄 14주차 (6월 2주차).png",
    ...
    {
      id: 12,
      image: "/images/0/cluster 4/주차 이미지/봄 13주차 (6월 1주차).png",
    ...
    {
      id: 13,
      image: "/images/0/cluster 4/주차 이미지/봄 12주차 (5월 4주차).png",
    ...
    {
      id: 14,
      image: "/images/0/cluster 4/주차 이미지/봄 11주차 (5월 3주차).png",
    ...
    {
      id: 15,
      image: "/images/0/cluster 4/주차 이미지/봄 10주차 (5월 2주차).png",
    ...
    {
      id: 16,
      image: "/images/0/cluster 4/주차 이미지/봄 9주차 (5월 1주차).png",
    ...
    {
      id: 17,
      image: "/images/0/cluster 4/주차 이미지/봄 8주차 (4월 4주차).png",
    ...
    {
      id: 18,
      image: "/images/0/cluster 4/주차 이미지/봄 7주차 (4월 3주차).png",
    ...
    {
      id: 19,
      image: "/images/0/cluster 4/주차 이미지/봄 6주차 (4월 2주차).png",
    ...
    {
      id: 20,
      image: "/images/0/cluster 4/주차 이미지/봄 5주차 (4월 1주차).png",
    ...
    {
      id: 21,
      image: "/images/0/cluster 4/주차 이미지/봄 4주차 (3월 4주차).png",
    ...
    {
      id: 22,
      image: "/images/0/cluster 4/주차 이미지/봄 3주차 (3월 3주차).png",
    ...
    {
      id: 23,
      image: "/images/0/cluster 4/주차 이미지/봄 2주차 (3월 2주차).png",
    ...
    {
      id: 24,
      image: "/images/0/cluster 4/주차 이미지/봄 1주차 (3월 1주차).png",
    ...
    {
      id: 25,
      image: "/images/0/cluster 4/주차 이미지/겨울 12주차 (2월 4주차).png",
    ...
    {
      id: 26,
      image: "/images/0/cluster 4/주차 이미지/겨울 11주차 (2월 3주차).png",
    ...
    {
      id: 27,
      image: "/images/0/cluster 4/주차 이미지/겨울 10주차 (2월 2주차).png",
    ...
    {
      id: 28,
      image: "/images/0/cluster 4/주차 이미지/겨울 9주차 (2월 1주차).png",
    ...
    {
      id: 29,
      image: "/images/0/cluster 4/주차 이미지/겨울 8주차 (1월 4주차).png",
    ...
    {
      id: 30,
      image: "/images/0/cluster 4/주차 이미지/겨울 7주차 (1월 3주차).png",
    ...
    {
      id: 31,
      image: "/images/0/cluster 4/주차 이미지/겨울 6주차 (1월 2주차).png",
    ...
    {
      id: 32,
      image: "/images/0/cluster 4/주차 이미지/겨울 5주차 (1월 1주차).png",
    ...
    {
      id: 33,
      image: "/images/0/cluster 4/주차 이미지/겨울 4주차 (12월 4주차).png",
    ...
    {
      id: 34,
      image: "/images/0/cluster 4/주차 이미지/겨울 3주차 (12월 3주차).png",
    ...
    {
      id: 35,
      image: "/images/0/cluster 4/주차 이미지/겨울 2주차 (12월 2주차).png",
    ...
    {
      id: 36,
      image: "/images/0/cluster 4/주차 이미지/겨울 1주차 (12월 1주차).png",
    ...
    {
      id: 37,
      image: "/images/0/cluster 4/주차 이미지/가을 6주차 (11월 4주차).png",
    ...
    {
      id: 38,
      image: "/images/0/cluster 4/주차 이미지/가을 5주차 (11월 3주차).png",
    ...
    {
      id: 39,
      image: "/images/0/cluster 4/주차 이미지/가을 4주차 (11월 2주차).png",
    ...
    {
      id: 40,
      image: "/images/0/cluster 4/주차 이미지/가을 3주차 (11월 1주차).png",
    ...
    {
      id: 41,
      image: "/images/0/cluster 4/주차 이미지/가을 2주차 (10월 4주차).png",
    ...
    {
      id: 42,
      image: "/images/0/cluster 4/주차 이미지/가을 1주차 (10월 3주차).png",
      ...
      <section className="cluster4-weekly-list">
        ...
        <div className="weekly-cards">
          {paginatedData.map((week) => (
            <Link href="/cluster-4-card" key={week.id} className="weekly-card" style={{ textDecoration: 'none', color: 'inherit' }}>
              {/* 왼쪽 이미지 */}
