                      ...
                      return (
                        <div key={starIndex} className="star-wrapper">
                          <svg className="star-bg" viewBox="0 0 24 24" fill="none" stroke="#FFA500" strokeWidth="2">
                            <path d="M31.98 0C31.98 8.47 29.48 16.09 25.35 22.63C19.63 25.59 16.12 27.95 12.25 29.56C8.38 31.17 4.23 32 0.04 32C4.24 32 8.4 32.82 12.27 34.43C16.15 36.03 19.68 38.39 22.64 41.35C25.61 44.32 27.97 47.85 29.57 51.72C31.17 55.6 32 59.76 31.99 63.95C31.99 59.76 32.82 55.6 34.43 51.72C36.03 47.85 38.39 44.33 41.36 41.36C44.32 38.39 47.85 36.04 51.73 34.43C55.6 32.83 59.76 32 63.96 32C59.76 32 55.6 31.17 51.71 29.55C47.82 27.95 44.29 25.6 41.32 22.64C38.35 19.68 35.99 16.15 34.38 12.28C32.77 8.4 31.94 4.24 31.94 0.05L31.98 0Z" />
                          </svg>
                          {isHalf && (
