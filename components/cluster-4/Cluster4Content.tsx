                          ...
                          return (
                            <div className="profile-card" key={reputation.id}>
                              ...
                              <div className="card-top">
                                ...
                                <div className="info">
                                  <div className="row1">
                                    <span style={{ display: 'inline-block', minWidth: '39px', maxWidth: '39px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.display_name || reviewer?.display_name === '-') ? 'left' : undefined }}>{truncate(reviewer?.display_name || "익명", 3)}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '14px', maxWidth: '14px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (genderLabel === '-') ? 'left' : undefined }}>{genderLabel}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '2ch', maxWidth: '2ch', textAlign: (!age && age !== 0) ? 'left' : 'right', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>{mask.age(age)}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '90px', maxWidth: '90px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.university || reviewer?.university === '-') ? 'left' : undefined }}>{truncate(mask.school(reviewer?.university), 7)}</span> <span className="separator">|</span>{" "}
                                    <span style={{ display: 'inline-block', minWidth: '90px', maxWidth: '90px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.major_first || reviewer?.major_first === '-') ? 'left' : undefined }}>{truncate(mask.major(reviewer?.major_first), 7)}</span>
                                  </div>
                                  <div className="row2">
                                    <span style={{ display: 'inline-block', minWidth: '84px', maxWidth: '84px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.teamName || reviewer?.teamName === '-') ? 'left' : undefined }}>{truncate(reviewer?.teamName, 6)}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '84px', maxWidth: '84px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.partName || reviewer?.partName === '-') ? 'left' : undefined }}>{truncate(reviewer?.partName, 6)}</span>
                                    {reviewer?.vision && (
                                      <>
                                        {" "}
                                        <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '109px', maxWidth: '109px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>{truncate(reviewer?.vision, 9)}</span>
                                      </>
                                    )}
                                  </div>
                                </div>
                        ...
                        return (
                          <div className="profile-card empty" key={`empty-${idx}`} style={{ cursor: "default" }}>
                            ...
                            <div className="card-top">
                              ...
                              <div className="info">
                                <div className="row1">
                                  <span style={{ display: 'inline-block', minWidth: '39px', maxWidth: '39px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '14px', maxWidth: '14px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '2ch', maxWidth: '2ch', textAlign: 'left', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '90px', maxWidth: '90px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '90px', maxWidth: '90px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span>
                                </div>
                                <div className="row2">
                                  <span style={{ display: 'inline-block', minWidth: '84px', maxWidth: '84px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '84px', maxWidth: '84px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>-</span>
                                </div>
                              </div>
                            </div>
                            <div className="tags" />
