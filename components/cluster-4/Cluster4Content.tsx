                          ...
                          return (
                            <div className="profile-card" key={reputation.id}>
                              ...
                              <div className="card-top">
                                ...
                                <div className="info">
                                  <div className="row1">
                                    <span style={{ display: 'inline-block', minWidth: '48px', maxWidth: '48px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.display_name || reviewer?.display_name === '-') ? 'left' : undefined }}>{truncate(reviewer?.display_name || "익명", 3)}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '18px', maxWidth: '18px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (genderLabel === '-') ? 'left' : undefined }}>{genderLabel}</span> <span className="separator">|</span> <span style={{ display: 'inline-block', minWidth: '2ch', maxWidth: '2ch', textAlign: (!age && age !== 0) ? 'left' : 'right', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>{mask.age(age)}</span> <span className="separator" style={{ margin: '0 1px' }}>|</span> <span style={{ display: 'inline-block', minWidth: '100px', maxWidth: '100px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.university || reviewer?.university === '-') ? 'left' : undefined }}>{truncate(mask.school(reviewer?.university), 7)}</span> <span className="separator" style={{ margin: '0 1px' }}>|</span>{" "}
                                    <span style={{ flex: '1 1 0', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px' }}>{truncate(mask.major(reviewer?.major_first), 7)}</span>
                                  </div>
                                  <div className="row2">
                                    <span style={{ display: 'inline-block', minWidth: '96px', maxWidth: '96px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.teamName || reviewer?.teamName === '-') ? 'left' : undefined }}>{truncate(reviewer?.teamName, 6)}</span> <span className="separator" style={{ margin: '0 1px' }}>|</span> <span style={{ display: 'inline-block', minWidth: '96px', maxWidth: '96px', whiteSpace: 'nowrap', verticalAlign: 'middle', fontFamily: "'Pretendard', sans-serif", fontSize: '14px', textAlign: (!reviewer?.partName || reviewer?.partName === '-') ? 'left' : undefined }}>{truncate(reviewer?.partName, 6)}</span>
                                    {reviewer?.vision && (
                                      <>
                                        {" "}
