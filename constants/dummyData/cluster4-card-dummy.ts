...
export const DUMMY_WEEK_CARD_DATA = {
  ...
  // === 주차 성장률 ===
  growthRate: {
    total: 15, completed: 9, rate: 60
  },

  // === 실무 4섹션 ===
  workSections: {
    info: {
      total: 7, completed: 5, rate: 71,
      cards: [
    ...
    ability: {
      ...
      cards: [
        { code: 'CP09 - UN010', category: '[실무 Info]인하우스 & 에이전시', rating: 6, mainBody: '[마케팅 실무] 현업에서 마케팅 업계를 구성하고 있는 인하우스 와 에이전시 의 개념, 그리고 내부 속성을 알아보자구!', subBody: '실무 역량의 서브타이틀이 50자면 어디까지 보일지 관건이고 이 사용자가 활용한 소재가 매력 매79..' }
      ]
    },
    experience: {
      total: 3, completed: 2, rate: 67,
      cards: [
        { code: 'EX01 - SFA01', category: '[커리어]마케터 Launch', rating: 6, mainBody: '[역량 파악 & 성장점 분석] "백날 말로만 떠드는 마케팅 커리어가 아니라, 지금 당장 어느 정도로 준비되었는지 그 현실을 뼈저리게 느껴보자구!"', subBody: '실무 역량의 서브타이틀이 50자면 어디까지 보일지 관건이고 이 사용자가 활용한 소재가 매력적으로 보이나 보이지 않나 보일까 보이지 않을까 보이는가 안 보이는가 보여 93...' },
    ...
    career: {
      ...
      cards: [
        ...
        { grade: 'A', date: '2025-12-22 (월)', supervisorName: '박준혁', supervisorRole: '브랜드마케팅 | 에스엠엔터테인먼트 | 과장', categoryTag: '마케팅(바이럴) 혹시 몰라', currentBid: '0,99', mainBody: '실무 역량의 메인타이틀이 브랜딩 입장에서 어디까지 소화되고 보여져야 UI상 문제가 없을지...', subBody: '실무 경력의 서브타이틀이 50자면 어디까지 보일지 관건이고 이 사용자가 활용한 소재의 매력도가 보여지나', profileImage: randomCrewProfile() },
        { grade: 'D', date: '2025-12-22 (월)', supervisorName: '알렉산더워싱턴최', supervisorRole: '글로벌마케팅전략사업부 | 에스엠엔터테인먼트코리아글로벌 | 수석매니저', categoryTag: '콘텐츠마케팅(퍼포먼스바이럴) 혹시 모를 카테고리', currentBid: '999,999', mainBody: '최대길이메인타이틀로이정도면충분히길텍스트가될것이라고생각하며브랜딩관점에서어디까지소화가능한지확인하는목적으로작성합니다아마도이정도면충분할것', subBody: '최대길이서브타이틀로가능한한많은글자를채워서어디까지보이는지확인하려는목적의텍스트이며구십삼자정도를목표로쓰고있습니다만약더필요하면더추가하겠습니다여기까지', profileImage: randomCrewProfile() },
      ]
    }
  }
};
