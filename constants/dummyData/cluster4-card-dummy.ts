...
const SHARED_CAREER_RECORDS: CareerRecord[] = [
  ...
  // 카드 2 — Overflow
  {
    ...
    week_id: "dw-01",
    company_name: "글로벌 디지털 마케팅 통합 솔루션 컨설팅 그룹 코리아 본부 에이전시",
    company_logo_url: "/images/0/cluster4/icon/실무 경력/감독자3.png",
    job_position: "전사 통합 마케팅 전략 디렉터 겸 글로벌 사업 총괄 책임자",
    project_name: "전사 통합 브랜드 마케팅 캠페인의 연간 전략 수립부터 글로벌 시장 진출을 위한 현지화 전략 그리고 디지털 채널 통합 운영 및 성과 분석 리포트까지 포함하는 마케팅 종합 프로젝트 보고서",
    ...
    supervisor_name: "글로벌마케팅총괄책임자김대표",
    supervisor_position: "최고마케팅책임자 겸 부사장",
    supervisor_department: "글로벌 디지털 마케팅 통합 솔루션 본부 전략실",
    supervisor_company: "글로벌 디지털 마케팅 통합 솔루션 컨설팅 그룹",
