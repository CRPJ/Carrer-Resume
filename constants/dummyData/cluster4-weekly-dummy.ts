...
export const DUMMY_WEEKLY_LIST: {
  ...
  { id: 'dw-17', weekNumber: 7, seasonYear: 2025, seasonName: '가을', startDate: '2025-11-24', endDate: '2025-11-30', isClubBreak: false, isBreakSeason: false, fromSeason: null, toSeason: null, holidayName: null, termNumber: null, growthStatus: '실패' },
...
export const DUMMY_WEEK_EXTRA: Record<string, {
  ...
  'dw-01': { // 휴식(개인) — 모두 0
    ...
    infoRate: { rate: 0, count: 0, total: 0 }, competencyRate: { rate: 0, count: 0, total: 1 },
    experienceRate: { rate: 0, count: 0, total: 0 }, careerRate: { rate: 0, count: 0, total: 0 },
    reputationCount: 0, fmScore: 0, colleagueCount: 0,
  },
  'dw-02': { // 실패
    points: { star: 5, shield: 4, lightning: 1 },
    teamPart: { teamName: null, partName: null }, roleLabel: '일반',
    growthRate: { rate: 15, count: 3, total: 20 },
    infoRate: { rate: 25, count: 1, total: 4 }, competencyRate: { rate: 0, count: 0, total: 1 },
    experienceRate: { rate: 50, count: 1, total: 2 }, careerRate: { rate: 0, count: 0, total: 3 },
    reputationCount: 1, fmScore: 1, colleagueCount: 0,
  },
  'dw-03': { // 성공
    points: { star: 25, shield: 20, lightning: 8 },
    teamPart: { teamName: '마케팅전략', partName: '브랜드콘텐츠' }, roleLabel: '심화',
    growthRate: { rate: 60, count: 8, total: 13 },
    infoRate: { rate: 50, count: 3, total: 6 }, competencyRate: { rate: 100, count: 1, total: 1 },
    experienceRate: { rate: 38, count: 3, total: 8 }, careerRate: { rate: 10, count: 1, total: 10 },
    reputationCount: 2, fmScore: 42, colleagueCount: 1,
  },
  'dw-04': { // 휴식(공식) 전환 — 모두 0
    points: { star: 0, shield: 0, lightning: 0 },
    teamPart: { teamName: null, partName: null }, roleLabel: '-',
    growthRate: { rate: 0, count: 0, total: 0 },
    infoRate: { rate: 0, count: 0, total: 0 }, competencyRate: { rate: 0, count: 0, total: 0 },
    experienceRate: { rate: 0, count: 0, total: 0 }, careerRate: { rate: 0, count: 0, total: 0 },
    reputationCount: 0, fmScore: 0, colleagueCount: 0,
  },
  'dw-05': { // 성공
    points: { star: 150, shield: 133, lightning: 45 },
    teamPart: { teamName: '미디어', partName: '웹툰드라마' }, roleLabel: '팀장(미디어 팀)',
    growthRate: { rate: 95, count: 62, total: 67 },
    infoRate: { rate: 96, count: 24, total: 25 }, competencyRate: { rate: 90, count: 9, total: 10 },
    experienceRate: { rate: 92, count: 11, total: 12 }, careerRate: { rate: 90, count: 18, total: 20 },
    reputationCount: 3, fmScore: 500, colleagueCount: 3,
  },
  'dw-06': { // 실패
    points: { star: 99, shield: 80, lightning: 30 },
    teamPart: { teamName: '개발', partName: '백엔드' }, roleLabel: '운영진(앰배서더)',
    growthRate: { rate: 75, count: 16, total: 24 },
    infoRate: { rate: 70, count: 7, total: 10 }, competencyRate: { rate: 50, count: 2, total: 4 },
    experienceRate: { rate: 80, count: 4, total: 5 }, careerRate: { rate: 60, count: 3, total: 5 },
    reputationCount: 2, fmScore: 325, colleagueCount: 2,
  },
  'dw-07': { // 실패
    points: { star: 3, shield: 9, lightning: 2 },
    teamPart: { teamName: '기획', partName: '전략파트' }, roleLabel: '일반',
    growthRate: { rate: 7, count: 1, total: 18 },
    infoRate: { rate: 10, count: 1, total: 10 }, competencyRate: { rate: 0, count: 0, total: 2 },
    experienceRate: { rate: 0, count: 0, total: 5 }, careerRate: { rate: 0, count: 0, total: 1 },
    reputationCount: 1, fmScore: 8, colleagueCount: 0,
  },
  'dw-08': { // 휴식(개인) — 모두 0
    points: { star: 0, shield: 0, lightning: 0 },
    teamPart: { teamName: null, partName: null }, roleLabel: '-',
  ...
  'dw-09': { // 성공
    ...
    reputationCount: 3, fmScore: 999, colleagueCount: 3,
  },
  'dw-10': { // 휴식(공식) 설날 — 모두 0
    points: { star: 0, shield: 0, lightning: 0 },
    teamPart: { teamName: null, partName: null }, roleLabel: '-',
  ...
  'dw-11': { // 실패
    ...
    teamPart: { teamName: '콘텐츠', partName: '영상' }, roleLabel: '심화(파트장)',
    growthRate: { rate: 50, count: 10, total: 23 },
    infoRate: { rate: 40, count: 4, total: 10 }, competencyRate: { rate: 33, count: 1, total: 3 },
    experienceRate: { rate: 67, count: 4, total: 6 }, careerRate: { rate: 25, count: 1, total: 4 },
    reputationCount: 2, fmScore: 120, colleagueCount: 1,
  },
  'dw-12': { // 휴식(개인)
    ...
    infoRate: { rate: 0, count: 0, total: 0 }, competencyRate: { rate: 0, count: 0, total: 0 },
    experienceRate: { rate: 0, count: 0, total: 0 }, careerRate: { rate: 0, count: 0, total: 0 },
    reputationCount: 1, fmScore: 15, colleagueCount: 0,
  },
  'dw-13': { // 휴식(공식) 전환 — 모두 0
    points: { star: 0, shield: 0, lightning: 0 },
    teamPart: { teamName: null, partName: null }, roleLabel: '-',
  ...
  'dw-14': { // 성공
    ...
    teamPart: { teamName: '사업개발전략', partName: '제휴협력사업' }, roleLabel: '팀장(사업개발전략 팀)',
    growthRate: { rate: 88, count: 37, total: 44 },
    infoRate: { rate: 85, count: 17, total: 20 }, competencyRate: { rate: 75, count: 3, total: 4 },
    experienceRate: { rate: 90, count: 9, total: 10 }, careerRate: { rate: 80, count: 8, total: 10 },
    reputationCount: 3, fmScore: 999, colleagueCount: 3,
  },
  'dw-15': { // 성공
    points: { star: 300, shield: 300, lightning: 100 },
    teamPart: { teamName: '교육', partName: '멘토링' }, roleLabel: '심화(파트장)',
    growthRate: { rate: 80, count: 19, total: 26 },
    infoRate: { rate: 80, count: 8, total: 10 }, competencyRate: { rate: 67, count: 2, total: 3 },
    experienceRate: { rate: 75, count: 6, total: 8 }, careerRate: { rate: 60, count: 3, total: 5 },
    reputationCount: 3, fmScore: 450, colleagueCount: 2,
  },
  'dw-16': { // 휴식(공식)
    ...
    infoRate: { rate: 0, count: 0, total: 0 }, competencyRate: { rate: 0, count: 0, total: 0 },
    experienceRate: { rate: 0, count: 0, total: 0 }, careerRate: { rate: 0, count: 0, total: 0 },
    reputationCount: 2, fmScore: 280, colleagueCount: 2,
  },
  'dw-17': { // 실패
    points: { star: 8, shield: 20, lightning: 5 },
    teamPart: { teamName: '디자인', partName: 'UI' }, roleLabel: '일반',
    growthRate: { rate: 15, count: 1, total: 11 },
    infoRate: { rate: 20, count: 1, total: 5 }, competencyRate: { rate: 0, count: 0, total: 1 },
    experienceRate: { rate: 0, count: 0, total: 3 }, careerRate: { rate: 0, count: 0, total: 2 },
    reputationCount: 1, fmScore: 30, colleagueCount: 1,
  },
  'dw-18': { // 성공
    points: { star: 400, shield: 500, lightning: 200 },
    teamPart: { teamName: '운영', partName: '총무' }, roleLabel: '운영진(앰배서더)',
    growthRate: { rate: 90, count: 39, total: 46 },
    infoRate: { rate: 90, count: 18, total: 20 }, competencyRate: { rate: 80, count: 4, total: 5 },
    experienceRate: { rate: 85, count: 11, total: 13 }, careerRate: { rate: 75, count: 6, total: 8 },
    reputationCount: 3, fmScore: 800, colleagueCount: 3,
  },
  'dw-19': { // 휴식(공식)
    points: { star: 0, shield: 0, lightning: 0 },
    teamPart: { teamName: null, partName: null }, roleLabel: '-',
  ...
  'dw-20': { // 성공
    ...
    teamPart: { teamName: '사업', partName: '제휴' }, roleLabel: '심화',
    growthRate: { rate: 70, count: 14, total: 23 },
    infoRate: { rate: 65, count: 6, total: 10 }, competencyRate: { rate: 50, count: 1, total: 2 },
    experienceRate: { rate: 60, count: 3, total: 5 }, careerRate: { rate: 67, count: 4, total: 6 },
    reputationCount: 2, fmScore: 350, colleagueCount: 2,
  },
};
